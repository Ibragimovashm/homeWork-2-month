...
console.log("Фильм : " + films.name + "\n" + "Количество эпизодов: " + films.episodes + "\n"  + "Был выпущен: " + films.releaseDate + "\n"  + "Главный актер: " + films.mainActor)
console.log("Второстепенные персонажи:  " + films.herois + "\n"  + "Название 1 эпизода: " + films.nameEpisodes.episod1 + "\nСамая сильная палочка: " + films.nameEpisodes.wands.wand)
////////////////////////////////////////2задание//////////////////////////////////////
